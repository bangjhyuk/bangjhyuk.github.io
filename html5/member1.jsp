...
<input id="id12" class="class3"type="text"name="sName" size="20" maxlenght="50" required/></div>
<div id="div2" class="class1">
<label id="id21" class="class2" for="id22">학번</label>
<input id="id22" class="class3"type="password"name="sNumber" size="20" maxlenght="50"/></div>
<div id="div3">
<label id="id31" for="id32">전화</label>
<input id="id32" class="class1 class2"type="text"name="sPhone" size="20" maxlenght="50"></div>
<div id="div4">
<p>테스트 버튼을 누르세요</p>
